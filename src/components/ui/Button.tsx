...
export function Button({ 
  ...
  const variants = {
    primary: "text-dark-600 bg-dark-100 hover:bg-dark-200 dark:bg-dark-100 dark:hover:bg-dark-200 focus:outline-none focus:ring-2 focus:ring-dark-200 dark:focus:ring-offset-dark-50",
